...
<div class="l-top-block-title">
<div class="b-top-block-title">
<h1 class="b-top-block-title__title">&nbsp;</h1>
</div>
</div>
</div>
</div>
...
<html lang="ru">
	...
	<link rel="stylesheet" href="/printing/assets/templates/print-template/bootstrap/css/bootstrap.min.css">
	<link rel=\'stylesheet\' href=\'/printing/assets/templates/print-template/css/owl.carousel.css\'>
	<link rel=\'stylesheet\' href=\'/printing/assets/templates/print-template/css/style.css\'>
	<link rel=\'stylesheet\' href=\'/printing/assets/templates/print-template/css/media.css\'>
    <!--<script src="/printing/assets/templates/print-template/js/jquery-1.12.0.min.js"></script> -->
	<script src="/printing/assets/templates/print-template/js/jquery-2.0.0.min.js"></script>
	<!-- <script src="/printing/assets/templates/print-template/js/jquery-3.1.1.min.js"></script> -->
	<script src="/printing/assets/templates/print-template/bootstrap/js/bootstrap.min.js"></script>
	<script src="/printing/assets/templates/print-template/js/owl.carousel.min.js"></script>
	<script src="/printing/assets/templates/print-template/js/main.js"></script>
</head>
<body>
...
<div class="l-wrapper">
		...
		<div class="l-main-header">
			<div class="l-container">
				<div class="b-logo">
					<a class="b-logo__link" href="/printing">
						<img class="b-logo__icon" src="/printing/assets/templates/print-template/image/base/logo-print.png" alt="Литография Принт">
					</a>
				</div>
				<nav class="l-main-menu">
				    <div class="b-burger-menu fa fa-bars" aria-hidden="true">
						<img class="b-burger-menu__img" src="/printing/assets/templates/print-template/image/base/bars.png" alt="меню">
					</div>
        				[[!Wayfinder? 
                            &startId=`0` 
                            &level=`2`
                            ...
                            &selfClass=`b-main-menu__link--active` 
                            &firstClass=`` 
                            &lastClass =`` 
                        ]]
				</nav>
			...
			<div class="l-container">
				...
				<div class="l-variety-services">
					<div class="b-variety-services clearfix">
						...
						<div class="l-variety-services__item mobile-hidden-xs">
						...
						<div class="l-variety-services__item mobile-hidden">
			...
			<div class="l-container">
				...
				<div class="b-advantages-content clearfix">
					<div class="b-advantages-content__item">
						<img class="b-advantages-content__icon b-advantages-production" src="/printing/assets/templates/print-template/image/base/print-icon.png"
					...
					<div class="b-advantages-content__item">
						<img class="b-advantages-content__icon b-advantages-quality" src="/printing/assets/templates/print-template/image/base/quality-icon.png"
					...
					<div class="b-advantages-content__item">
						<img class="b-advantages-content__icon b-advantages-shield" src="/printing/assets/templates/print-template/image/base/shield-icon.png"
						     alt="Огромный опыт">
					...
					<div class="b-advantages-content__item">
						<img class="b-advantages-content__icon b-advantages-range" src="/printing/assets/templates/print-template/image/base/range-icon.png"
						     alt="Спектр услуг">
				...
				<p class="b-advantages-about">
					Высокое качество предоставляемых услуг и доверие между деловыми партнерами – залог успеха каждого
					бизнеса. «Литография Принт» предлагает лучшее соотношение качества, цены, сервиса и оперативности.
					Каждый заказ партнеров нашей типографии выполняется согласно этой формуле. Наша команда всегда
					нацелена на результат и на построение долгосрочных деловых взаимоотношений с партнером. Звоните в
					любое удобное время, будем рады помочь Вам!
				</p>
			</div>
		</div>
		...
		<div class="clearfix">
			<div class="l-menu-footer">
	             [[!Wayfinder? 
		               &startId=`0` 
		               &level=`1`
		               &outerTpl=`menu-outer-footer` 
		               &rowTpl=`menu-row-footer` 
		         ]] 
			</div>
